...
class DGG_LearnableK_Small(nn.Module):
    ...
    def __init__(
        ...
        super(DGG_LearnableK_Small, self).__init__()
...
class DGG_LearnableK_debug(nn.Module):
    ...
    def __init__(self, in_dim=32, latent_dim=64, args=None):
        ...
        self.in_dim = in_dim
        self.latent_dim = latent_dim
        self.extra_edge_dim = 2 # args.extra_edge_dim
        self.extra_k_dim = 1 # args.extra_k_dim
        self.hard = False # args.dgg_hard
        self.deg_mean = 3.899 # args.deg_mean
        self.deg_std = 5.288 # args.deg_std
        ...
        self.edge_prob_net_mode = "u-v-dist" # args.dgg_mode_edge_net
        ...
        self.k_net_mode = "pass" # args.dgg_mode_k_net
        ...
        # Top-k selector
        self.k_select_mode = "edge_p-cdf" # args.dgg_mode_k_select
    ...
    def forward(self, x, in_adj, noise=True, writer=None, epoch=None):
        ...
        debug_step = 0
        perturb_edge_prob = False
        if debug_step == 0: # self.args.debug_step == 0:
        ...
        if perturb_edge_prob: # self.args.perturb_edge_prob:
            # add gumbel noise to edge log probabilities
            edge_p = edge_p + 1e-8
            log_p = torch.log(edge_p)  # [1, N, N]
        ...
        if debug_step == 1: # self.args.debug_step == 1:
